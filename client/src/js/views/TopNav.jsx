...
import { Navbar, Nav, NavItem, NavDropdown, OverlayTrigger } from 'react-bootstrap';
              ...
              {isCurrentUserAdmin && (
                <NavDropdown id="admin-dropdown" title="Administration">
                  <LinkContainer to={{ pathname: `/${Constant.USERS_PATHNAME}` }}>
                    <NavDropdown.Item eventKey={5}>User Management</NavDropdown.Item>
                  </LinkContainer>
                  <LinkContainer to={{ pathname: `/${Constant.ROLES_PATHNAME}` }}>
                    <NavDropdown.Item eventKey={6}>Roles and Permissions</NavDropdown.Item>
                  </LinkContainer>
                </NavDropdown>
              )}
            </Nav>
